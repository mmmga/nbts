...
The version number of this plugin reflects the version of TypeScript it incorporates (currently 2.0.3), with an extra digit for new versions that do not involve a TypeScript update. We intend to keep this plugin up to date with new versions of TypeScript when they come out.
...
* Edit this line in `build.xml` to point to where you have TypeScript installed:  
  `<property name="typescript" value="${env.HOME}/TypeScript-2.0.3"/>`
